...
<div id="loginDiv" style="height: 350px">
    <form action="/Personal_Clinic_Management_System_war/medico/Login" id="form" method="post">
        <h1 id="loginMsg">医生登录</h1>
        ...
        <div id="subDiv">
            ...
            <a href="${pageContext.request.contextPath}/jsp/register2.jsp">没有账号？</a>
        </div>
    </form>
</div>
