...
<div class="form-div">
    <div class="reg-content">
        <h1>管理员注册</h1>
        <span>已有帐号？</span> <a href="/Personal_Clinic_Management_System_war/jsp/login.jsp">登录</a>
        <br>
        <span id="notice" class="err_msg" style="display: none" >注册成功</span>
    </div>
    <form id="reg-form" action="/Personal_Clinic_Management_System_war/administrator/Register" method="get">
